...
//写邮件  账号接口
export const url_amazon_write_account = "get|amazon-emails/ ";
export const api_amazon_write_account = function(){
    return http(url_amazon_write_account);
};
//写邮件 客服列表
...
//重新发送
export const url_amazon_resend = "get|amazon-emails/sent-mails/resend/:mail_id";
