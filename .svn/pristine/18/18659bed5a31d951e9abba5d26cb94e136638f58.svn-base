...
//历史数据
export const url_wish_history = 'get|wish-account-health/:id/history';
export const api_wish_history = function (id) {
    return http(Url2(url_wish_history,{id:id}));
};
// 付款记录
export const url_wish_pay = 'get|wish-account-health/:id/payment';
export const api_wish_pay = function (id) {
    return http(Url2(url_wish_pay,{id:id}));
};
// 导出
...
//查看 编辑
export const url_wish_edit = 'get|wish-account-health/:id/goal';
