<template>
    <page-dialog v-model="dialog" title="SKU图片查重" @open="open">
        ...
        <div slot="footer">
            <el-button type="primary" size="mini" class="inline" @click.native="check_repetition">开始查重</el-button>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            check_repetition(){
                if(!this.phash)return this.$message({type:'warning',message:'尚未添加任何图片'});
                this.dialog = false;
