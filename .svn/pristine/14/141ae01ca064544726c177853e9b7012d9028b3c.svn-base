            ...
            >
                ...
                <template v-for="(row,index) in tables.lists">
                    <tr :key="row.id">
                        ...
                        <td>
                            <ui-tip :content="row.waiting_shipping_quantity"></ui-tip>
                        </td>
                        <td>
                        ...
                        <td>
                            <trends-select class="inline" @trigger="action(row,$event)" :selects="m_option(row)"
...
<script>
    import {api_local_detail} from '@/api/local';
