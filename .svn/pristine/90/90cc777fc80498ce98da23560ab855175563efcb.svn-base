        ...
        <el-row>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>  <el-input v-model="sendData.buyer_id" class="inline inputs" :disabled="isLoad"></el-input></td>
                </tr>
                <tr>
...
<script>
    import {api_amazon_writ_load,api_amazon_write_account,api_amazon_write_customer,api_amazon_write,url_amazon_writ_load,url_amazon_write} from "../../../../api/letter-amazon"
        ...
        methods: {
            ...
            load(num){
                ...
                this.$http(api_amazon_writ_load,this.sendData.order_number_type,number).then(res=>{
                    ...
                    this.sendData.buyer_id=res.data.buyer_id;
            ...
            get_accout(){
                this.$http(api_amazon_write_account).then(res=>{
                    this.accounts= [{code:'全部', id:''}, ...res.data];
                }).catch(code=>{
                    this.$message({type: "error", message: code.message || code})
                })
            },
            ...
            send(){
                ...
                if(this.isLoad){
                    ...
                    param={
                        ...
                        buyer_id:this.sendData.buyer_id,
