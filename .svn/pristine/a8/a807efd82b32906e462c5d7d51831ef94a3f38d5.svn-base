<template>
    <page-dialog :title="action.title"
        ...
        <el-form :model="ruleData" class="mt-sm mb-sm">
            <el-form-item :label="$t('ymx-up-lower-rule.ruleName')+'：'" label-width="100px" required class="inline ml-sm mr-sm">
                <el-col>
                    <el-input v-model="ruleData.rule_name"></el-input>
                </el-col>
            </el-form-item>
            <el-form-item :label="$t('ymx-up-lower-rule.availableTime')+'：'" label-width="100px" required class="inline mr-sm">
                <el-col>
                    <el-date-picker
            ...
            <el-form-item :label="$t('ymx-up-lower-rule.status')+'：'" label-width="100px" class="inline">
                <el-col>
            ...
            <tr style="background-color: #d6e9c6">
                <td colspan="16">
                    <div class="inline fl mt-xs mb-xs">
                        <label-item :label="$t('ymx-up-lower-rule.displayTime')+'：'" class="ml-sm inline mr-sm">
