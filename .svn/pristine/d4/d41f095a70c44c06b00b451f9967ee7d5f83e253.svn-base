<template>
    <div class="c-extract-keyword">
        <page-dialog v-model="dialog" :title="title" size="small" :close-on-click-modal="false">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            add_data(){
                if(this.neededLength===0)return this.$message({type:"warning",message:"核心关键词最多添加10个，请删除一部分后，再进行此操作"});
