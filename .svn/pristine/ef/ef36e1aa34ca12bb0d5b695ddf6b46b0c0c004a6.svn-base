<template>
    <div>
        <el-input class="inline width-200" style="vertical-align: top" v-model="categoryCode" placeholder="请输入分类编码"
                  @blur="search_code"></el-input>
        <el-button type="primary" style="vertical-align: top"
                   size="mini" @click.native="choice_category_first">请选择产品分类1</el-button>
        <el-button type="primary" style="vertical-align: top"
                   :disabled="!form.category_name"
                   size="mini" @click.native="choice_category_second">请选择产品分类2</el-button>
