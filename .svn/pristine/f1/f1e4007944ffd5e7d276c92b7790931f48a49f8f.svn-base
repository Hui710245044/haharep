...
//                        }
            ...
            submit_sku(val,goods){
                ...
                val.forEach(row=>{
                    ...
                    let curObj = {
                        ...
                        v_price:!!this.curSite.official_rate?`${(parseFloat(row.market_price)/parseFloat(this.curSite.official_rate)).toFixed(2)}`:'',
                        v_qty:"",
            ...
            mdfimg_submit(val){
                ...
                if(!!curObj) curObj.path = val.path;
            },
        },
        watch:{
