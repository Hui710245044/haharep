        ...
        <mailing-method ref="mailing">
            ...
            <div slot="button-list">
                <permission tag="request-button"
                            ...
                            class="ml-sm"
                            :route="apis.url_free_packages">释放包裹</permission>
                <permission tag="request-button"
                            type=""
                            @click="batch_produce"
                            ...
                            :route="apis.url_batch_produce">批量生成拣货单</permission>
                <permission tag="request-button"
                            type=""
                            ...
                            class="ml-sm"
                            :disabled="this.selectList.length <= 0"
                            :route="apis.url_make_quick">批量生成快速发货区拣货单</permission>
            </div>
            <!-- 表格 -->
            <el-table
                slot="goods-tabel"
                ...
                <el-table-column
                    ...
                    label="包裹号">
                    <div>
                        <ui-tip :is-operate="true" :content="row.number" :width="98" @cur-click="parcel_information(row.number)"></ui-tip>
                    </div>
                </el-table-column>
                <el-table-column
                    label="追踪号"
...
<script>
    ...
    import {url_free_packages,api_free_packages,url_batch_produce,api_make_quick,url_make_quick,api_batch_produce,} from '../../../api/packages';
    export default {
        permission: {
        ...
        methods: {
            ...
            free_packages(){
                ...
                return this.$http(api_free_packages,{warehouse_id:this.selectList[0].warehouse_id,ids:ids}).then(res=>{
                    id.forEach(item=>{
