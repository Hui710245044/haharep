<template>
    <page class="channel-profit">
        <search-module ref="search_module" :searchData="searchData" :clears="clears" @search="search">
        </search-module>
    ...
    export default{
        ...
        methods:{
            ...
            addAccount(){
                ...
                this.editData.initiate_time = Date.now();
                this.addVisiable = true;
                this.$http(api_get_channel_company_info).then(res => {
