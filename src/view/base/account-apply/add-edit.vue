    ...
    <div>
        <page-dialog :title="action.title"
            ...
            <div>
                ...
                <div class="tabs-content form-body-scroll">
                    <div class="tabs-content-pane card">
                        <el-tabs type="card" :active-name="actionName" ref="tabs" @tab-click="tab_click">
                            <el-tab-pane key="base-info" name="base-info" label="基本信息" class="roll-height">
                                    <el-form label-width="200px" :model="editData" ref="editForm">
                                        ...
                                        <el-form-item label="负责人：">
                                            <scroll-select v-model="accounts" style="width:177px" class="inline"
                                                           textAlign="left"
                                        ...
                                        <el-form-item label="站点：">
                                            <el-select :disabled="siteOptions.length===0||notRegister"
                                        ...
                                        <el-form-item class="mt-lg">
                                            <request-button req-key="sureKey" @click="sure">确定</request-button>
                                            <el-button @click.native="restore" size="mini" >取消</el-button>
                                        </el-form-item>
                                    </el-form>
                                </el-tab-pane>
                            <el-tab-pane key="provider-info" name="register-info" label="注册信息" class="roll-height" >
                                <el-form label-width="200px" :model="editData" ref="editForm">
                                    <el-row>
                                    <el-col :span="12">
                                    ...
                                    <el-row>
                                        <el-col :span="12">
                                            <el-form-item label="公司地址+邮编：">
                                                <el-col :span="col11">
                                                    <el-input type="text"
                                                              v-model="editData.company_address" :disabled="hasRegister">
                                                    </el-input>
                                                </el-col>
                                            </el-form-item>
                                        </el-col>
                                    ...
                                    <el-row class="mt-lg">
                                        <el-form-item>
                                            <request-button req-key="sureKey" @click="sure">确定</request-button>
                                            <el-button @click.native="register_info" size="mini" >取消</el-button>
                                        </el-form-item>
                                    </el-row>
                                </el-form>
                            </el-tab-pane>
                            <el-tab-pane key="specification-info" name="examine-info" label="审核"  class="roll-height">
                                <el-form label-width="200px" :model="editData" ref="editForm">
                                    <el-form-item label="地址账单：">
                                        <el-col :span="col11">
                                            <el-input
                                                type="text"
                                                :disabled="hasAudit"
                                                v-model="editData.address_billing">
                                            </el-input>
                                        </el-col>
                                    </el-form-item>
                                    ...
                                    <el-form-item class="mt-lg" style="height:141px;">
                                        <el-button size="mini" type="primary">审核通过</el-button>
                                        <el-button size="mini" type="primary" @click="audit_failed">审核未通过</el-button>
                                        <el-card style="position: absolute;right:460px;bottom:-120px;z-index: 99999;"
                            ...
                            <el-tab-pane key="product-attr" name="register-result" label="注册结果"  class="roll-height">
                                <el-form label-width="200px" :model="editData" ref="editForm">
                                    ...
                                    <el-form-item class="mt-lg">
                                        <request-button req-key="sureKey" @click="sure">确定</request-button>
                                        <el-button @click.native="register_result" size="mini" >取消</el-button>
                                    </el-form-item>
                                </el-form>
                            </el-tab-pane>
                            <el-tab-pane key="remark-msg" name="remark-operation" label="操作日志"  class="roll-height">
                                <el-form :model="editData">
                                    <el-table border
                                        ...
                                        <el-table-column
                                            ...
                                            prop="remark"
                                            inline-template>
                                            <div v-for="(content,index) in row.remark" :key="index">
                                                {{content}}
                                            </div>
                                        </el-table-column>
                                    </el-table>
...
<script>
    ...
    import {api_add_account,
            api_updata_account,
            api_get,
            api_get_already,
            api_get_account_log,
    } from '../../../api/account-apply'
    ...
    export default {
        ...
        methods: {
            ...
            submit_cancel(){},
            register_result(){
                this.$set(this.editData, 'fulfill_time', '');
                this.$set(this.editData, 'account_code', '');
                this.$set(this.editData, 'account_show_id', '');
            },
            register_info(){
                console.log('2', this.editData);
                this.$set(this.editData, 'register_time', '');
                this.$set(this.editData, 'email', '');
                this.$set(this.editData, 'phone', '');
                this.$set(this.editData, 'email_password', '');
                this.$set(this.editData, 'company_registration_number', '');
                this.$set(this.editData, 'account_name', '');
                this.$set(this.editData, 'company_time', '');
                this.$set(this.editData, 'password', '');
                ...
                this.$set(this.editData, 'collection_type', '');
                this.$set(this.editData, 'corporation_address', '');
                this.$set(this.editData, 'collection_email', '');
            },
            restore(){
                this.$set(this.editData, 'initiate_man_name', '');
                this.$set(this.editData, 'channel_id', '');
                this.$set(this.editData, 'site_code', '');
                this.$set(this.editData, 'breed', '');
                this.$set(this.editData, 'company', '');
                this.$set(this.editData, 'charter_url', '');
                this.$set(this.editData, 'company_type', '');
                this.$set(this.editData, 'corporation', '');
                this.$set(this.editData, 'corporation_id_front', '');
                this.$set(this.editData, 'corporation_id_contrary', '');
                this.$set(this.editData, 'credit_card', '');
                this.$set(this.editData, 'vat', '');
            },
            tab_click(val){
                this.activeName=val.name;
                console.log('4343', val);
            ...
            verification_data(){
                if(this.activeName === 'base-info'){
                    ...
                    if(this.editData.vat.trim()===''){
                        this.$reqKey('sureKey',false);
                        this.$message({type:"warning", message:"请输入VAT！"});
                        return false
                    }
                }
                    if(!this.hasRegister && this.activeName === 'register-info'){
                    ...
                    if(!this.hasEnrollResults && this.activeName === 'register-result'){
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        ...
                        if(this.action.value === 'add'){
                            ...
                            console.log('reddds', this.ids);
                            this.$http(api_get_account_log,this.ids).then(res => {
                                console.log('rs', res);
                            }).catch(code => {
                                console.log(code);
                            })
        ...
        computed: {
            ...
            sitePlaceholder(){
                if(this.editData.channel_id.length<=0){
                    return "请先选择平台";
