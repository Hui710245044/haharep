    ...
    <div class="purchase-apply-data-table">
        <div class="mb-sm mt-sm">
            ...
            <div class="fr mt-sm red bold-font">
                ...
                <span class="ml-lg">已付款金额：CNY {{payTotal.CNY | pay_filter}}<span class="ml-md">USD：</span>{{payTotal.USD | pay_filter}}</span>
                </div>
        ...
        <el-table
            ...
            <el-table-column label="申请付款总额" min-width="65" inline-template>
                <div class="p-table-list-td-text" :title="row.apply_amount|filterAmount">{{row.apply_amount | filterAmount}}</div>
            </el-table-column>
            <el-table-column label="已付款金额" min-width="65" inline-template>
            ...
            <el-table-column label="最迟付款时间" inline-template min-width="90" show-tooltip-when-overflow>
                <!--<times :time="row.create_time"></times>-->
                <ui-tip :content="row.create_time_date" :width="88" :class="{'red-color': showColor}"></ui-tip>
            </el-table-column>
            <el-table-column label="付款时间" inline-template min-width="90" show-tooltip-when-overflow>
                <ui-tip :content="row.create_time_date" :width="88"></ui-tip>
            </el-table-column>
        ...
        <!--操作日志-->
        <operation-log v-model="log_view" :checkList="checkListMy"></operation-log>
        <!--标记付款-->
        <mark-pay v-model="markPayVisable" :checkList="checkListMyLog" :title="look_title"></mark-pay>
        <!--批量审核不通过-->
        ...
        data() {
            return {
                ...
                checkListMyLog:[
                    {
                        pay: 18091818,
                        super: '深圳市龙岗区琦悦诗化妆品批发商行',
                        type: '定期结算-半月结',
                        time: '2018-06-27 10:59:29',
                        late: '1545667200',
                        status: 'CNY',
                        currency: '91232',
                        dopay: '4322',
