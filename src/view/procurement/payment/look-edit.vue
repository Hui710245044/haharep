    ...
    <page-dialog class="purchase-look" v-model="visible" @close="close" size="large" :title="title">
        <div class="mt-lg">
            <el-row>
                <el-col :span="10" :offset="2">
                    <div class="row-content">
                        <span>申请付款总额 : </span> <span>{{checkList.currency_code}} {{checkList.apply_amount | filtersPay}} ,
                        USD {{checkList.apply_amount | filtersPay}}</span>
                    </div>
                </el-col>
                <el-col :span="10">
                    <div class="row-content">
            ...
            <el-row>
                ...
                <el-col :span="10">
                    <div class="row-content">
                        <span>最迟付款时间 : </span> <span>{{checkList.create_time_date}}</span>
                    </div>
                </el-col>
            </el-row>
