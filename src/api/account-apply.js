...
//获取状态列表
export const url_get_account_status = "get|account-apply/status";
export const api_get_account_status = function (data) {
    return http(Url2(url_get_account_status), data);
};

//获取状态btn
export const url_get_account_basics_changes = "get|account-apply/status";
...
//获取操作日志account-apply/:id/log
export const url_get_account_log = "get|account-apply/:id/log";
export const api_get_account_log = function (id){
    return http(Url2(url_get_account_log, {id:id}));
};
//获取平台公司资料
export const url_get_channel_company_info = "get|account-company/company";
export const api_get_channel_company_info = function (data){
    return http(url_get_channel_company_info, data);
};
